...
class UncontrolledAgent(object):
    def __init__(self):
        ...
        cos_thetat = sp.Symbol("ct")
        sin_thetat = sp.Symbol("st")
        sin_wthetat = sp.Symbol("cwt")
        cos_wthetat = sp.Symbol("swt")
        ...
        self._sin_thetat = tro.BaseVariable(sin_thetat, set(range(big_number)), sin_thetat * cos_wthetat + cos_thetat * sin_wthetat)
        self._cos_thetat = tro.BaseVariable(cos_thetat, set(range(big_number)), cos_thetat * cos_wthetat - sin_thetat * sin_wthetat)
